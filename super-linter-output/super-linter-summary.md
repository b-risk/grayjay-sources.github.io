...
For more information, see the [GitHub Actions workflow run](https://github.com/grayjay-sources/grayjay-sources.github.io/actions/runs/25148714955)
...
```text
Checked 10 files in 611ms. No fixes applied.
...
Checked 13 files in 1747ms. No fixes applied.
Found 547 errors.
Found 3889 warnings.
